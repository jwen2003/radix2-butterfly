# Fmax sweep point: 416.7 MHz timing environment for the V0 evaluation wrapper.
# This constraint is specific to the V0 frequency sweep.

create_clock -name core_clock -period 2.400 [get_ports clk]
...
set_input_delay 0.240 -clock core_clock $data_inputs
set_output_delay 0.240 -clock core_clock [all_outputs]
