# Common 500 MHz timing environment for the registered Butterfly evaluation
# wrappers. Keep this file identical between V0 and V1.
...
set_input_delay 0.200 -clock core_clock $data_inputs
set_output_delay 0.200 -clock core_clock [all_outputs]
