# Fmax sweep point: 600 MHz timing environment for the V1 evaluation wrapper.
# This constraint is specific to the V1 frequency sweep.

create_clock -name core_clock -period 1.667 [get_ports clk]
...
set_input_delay 0.167 -clock core_clock $data_inputs
set_output_delay 0.167 -clock core_clock [all_outputs]
